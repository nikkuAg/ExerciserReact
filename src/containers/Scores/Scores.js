...
class Scores extends Component {
  ...
  redo = () => {
    ...
    if (type === "MCQ") {
      this.props.router.navigate("/play/mcq", {
        state: { exercise: exercise },
      });
    }
    if (type === "CLOZE") {
      this.props.router.navigate("/play/cloze", {
        state: { exercise: exercise },
      });
    }
    if (type === "REORDER") {
      this.props.router.navigate("/play/reorder", {
        state: { exercise: exercise },
      });
    }
    if (type === "GROUP_ASSIGNMENT") {
      this.props.router.navigate("/play/group", {
        state: { exercise: exercise },
      });
    }
    if (type === "FREE_TEXT_INPUT") {
      this.props.router.navigate("/play/freeText", {
        state: { exercise: exercise },
      });
    }
    if (type === "MATCHING_PAIR") {
      this.props.router.navigate("/play/match", {
        state: { exercise: exercise },
      });
    }
  };
...
export default withScoreHOC()(
  injectIntl(withRouter(connect(MapStateToProps, {})(Scores)))
);
